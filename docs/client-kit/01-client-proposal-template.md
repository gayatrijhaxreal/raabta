...
- Admin panel to view enquiries and customer details
- Secure backend API with protected admin routes
...
If you want, I can share a detailed package sheet and start immediately.
